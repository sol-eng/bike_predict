...
pins::pin_write(
  ...
  title = "Bike Predict (R) - ELT - Pinned Station Info",
...
# Get the content
content <- client %>%
  connectapi::content_item("00036e13-9a3c-44c6-84eb-253de91b10c2")
...
content %>%
  ...
  connectapi::set_vanity_url("bike-predict-r-station-info-data-pin", force = TRUE)
```
