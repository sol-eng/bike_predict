...
content$update(access_type = "all")
set_content_tags(content, tags$R$ETL)
set_image_path(content, "./img/pins-data-icon.drawio.png")
```
...
content$update(access_type = "all")
set_content_tags(content, tags$R$Model)
set_image_path(content, "./img/pins-model-icon.drawio.png")
```
...
content$update(access_type = "all")
set_content_tags(content, tags$R$Model)
set_image_path(content, "./img/plumber-icon.drawio.png")
```
...
set_content_tags(content, tags$R$App)
set_image_path(content, "./content/03-app/01-client-app-dev/icon.drawio.png")
```
