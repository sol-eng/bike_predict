...
tibble::tribble(
  ...
  "bikeHelpR Package", "Tags", "An R package of helper functions, built in internal repo on colorado.rstudio.com/rspm.") %>%
  bind_cols(
    tibble::tribble(
      ...
      "https://colorado.rstudio.com/rspm/client/#/repos/8/packages/bikeHelpR", "blob/master/pkg", NA
    )
  ) %>%
  dplyr::mutate(
